...
public class Immagini
{
    ...
    public int SalvaImmaginePost(HttpPostedFile oImgSpedita, Oggetti.OggettoFoto oFoto, int ID, out string percorso, out string estensione)
    {
        try
        {
            int iRetVal = 0;
            estensione = oImgSpedita.FileName.Substring(oImgSpedita.FileName.LastIndexOf("."), oImgSpedita.FileName.Length - oImgSpedita.FileName.LastIndexOf("."));
            ...
            if (oImgSpedita != null)
            {
                ...
                if (oImgSpedita.ContentLength > 0)
                {
                    ...
                    // creo l'immagine
                    System.Drawing.Image oImage = System.Drawing.Image.FromStream(oImgSpedita.InputStream);
